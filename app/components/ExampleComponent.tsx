...
const ExampleComponent = () => {
	...
	const method1Example = (
		<View
			className={`p-4 rounded-lg mb-4 ${themed.bg.background} ${themed.border.primary} border-2`}>
	...
	const method2Example = (
		<View className={cn('p-4 rounded-lg mb-4 border-2', themedClasses.card)}>
			...
			<TouchableOpacity
				className={cn('px-4 py-2 rounded', themedClasses.button)}>
				<Text className='text-white text-center'>Primary Button</Text>
			</TouchableOpacity>
		</View>
	);
	...
	const method3Example = (
		<View
			className={cn(
				...
				getThemedClassName(
					'bg-light-background border-light-primary',
	...
	return (
		<View className='p-4'>
			<Text
				className={`text-2xl font-bold mb-6 text-center ${themed.text.primary}`}>
			...
			{/* Input example */}
			<View
				className={`p-4 rounded-lg ${themed.bg.background} ${themed.border.secondary} border`}>
				<Text className={`text-base mb-2 ${themed.text.primary}`}>
					Input Example:
				</Text>
				<TextInput
					className={cn('p-3 rounded border', themedClasses.input)}
