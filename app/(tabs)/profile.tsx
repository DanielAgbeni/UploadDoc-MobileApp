...
const Profile = () => {
	...
	type ModalButtonVariant = 'primary' | 'danger' | 'secondary';
	...
	const onRefresh = useCallback(async () => {
		...
		try {
			...
			setModalConfig({
				title: 'Refresh Error',
				message: 'Could not update profile data. Please try again.',
		...
		<>
			<ScrollView
				...
				<View className='px-6 pt-6 -mt-4'>
					...
					{user?.isAdmin && (
						<View
							className={`${themed.bg.card} rounded-2xl p-5 mb-6 shadow-sm`}>
					...
					<View className='gap-4 mb-8'>
						{[
								...
								: []),
							{
								...
								onPress: () =>
									Linking.openURL(
										'https://uploaddoc.vercel.app/privacy-policy',
									),
							},
